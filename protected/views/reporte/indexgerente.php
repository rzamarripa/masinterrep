<?php
	...
	$reportes = Reporte::model()->findAll("estatus_did != 7");
?>
<div class="row">
	<div class="span12">
		<div class="tabbable"> <!-- Only required for left/right tabs -->
		  	<ul class="nav nav-tabs">
				...
				<li><a href="#tab2" data-toggle="tab"><i class='icon-cog'></i> Revisados</a></li>		
				<li><a href="#tab3" data-toggle="tab"><i class='icon-trash'></i> Papelera reciclaje</a></li>
			</ul>
			<div class="tab-content">
		    	<div class="tab-pane active" id="tab1">
					<?php $this->renderPartial("_reportesPendientesAdmin",array('reportes'=>$reportes)); ?>
				</div>
				<div class="tab-pane" id="tab2">
					<?php $this->renderPartial("_reportesRevisadosAdmin",array('reportes'=>$reportes)); ?>
				</div>
				<div class="tab-pane" id="tab3">
					<?php $this->renderPartial("_reportesPapeleraAdmin",array('reportes'=>$reportes)); ?>
				</div>
			</div>
		</div>
	</div>
