				...
				<tr>
					...
					<td>
					    ...
					    $this->widget('bootstrap.widgets.TbButtonGroup', array(
					        ...
					        'buttons'=>array(
					            array('items'=>array(
					            	array('label'=>'Recuperar', 'icon'=>'share', 'url'=>array('cambiarestatus','id'=>$reporte->id, 'estatus'=>1)),
					                array('label'=>'Más detalles', 'icon'=>'list-alt', 'url'=>array('view','id'=>$reporte->id)),
					                '---',
					                array('label'=>'Eliminar definitivamente', 'icon'=>'trash', 'url'=>array('cambiarestatus','id'=>$reporte->id, 'estatus'=>5)),
					            )),
					        ),
					    )); ?>
					</td>
