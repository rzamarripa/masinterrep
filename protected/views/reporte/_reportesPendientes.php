				...
				<tr>
					...
					<td>
					    ...
					    $this->widget('bootstrap.widgets.TbButtonGroup', array(
					        ...
					        'buttons'=>array(
					            array('items'=>array(
					                array('label'=>'Enviar', 'icon'=>'plane', 'url'=>array('cambiarestatus','id'=>$reporte->id, 'estatus'=>2)),
					                array('label'=>'Actualizar', 'icon'=>'pencil', 'url'=>array('update','id'=>$reporte->id)),
					                '---',
