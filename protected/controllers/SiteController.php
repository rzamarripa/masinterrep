...
class SiteController extends Controller
{
	...
	public function actionIndex()
	{
        ...
        elseif(isset($usuarioActual) && $usuarioActual->tipoUsuario->nombre == 'Usuario A' || isset($usuarioActual) && $usuarioActual->tipoUsuario->nombre == 'Usuario B' || isset($usuarioActual) &&  $usuarioActual->tipoUsuario->nombre == 'Usuario C'){			
			$this->render('gerente');
		}
		else{
			$this->render('index');
